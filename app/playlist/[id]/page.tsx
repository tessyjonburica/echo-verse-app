    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div className="flex-1 space-y-2">
          ...
          {playlist.songs.length > 0 && (
            <Button onClick={() => handlePlaySong(0)} className="mt-4">
              Play All
            </Button>
          )}
        </div>
      ...
      {playlist.songs.length === 0 ? (
        <div className="text-center py-12">
          <h3 className="text-xl font-medium">This playlist is empty</h3>
          <p className="text-muted-foreground mt-2">Add songs to your playlist from the library or search page</p>
        </div>
      ) : (
